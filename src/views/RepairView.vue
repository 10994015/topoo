...
// 模擬資料 (實際開發時移除)
const mockData = {
  id: "85d5d47c-34c1-4cb5-abce-53adbbа52228",
  repair_id: "C202505080001",
  repair_category: "軟體",
  repair_reason: "執著沒有反應",
  repair_item: "無",
  device_location: "無",
  repair_name: "OO科技公司-資訊部-專案管理-第一OO",
  repair_time: "2025/05/08 08:30",
  finish_time: "2025/05/08 10:30",
  repair_status: "已完成",
  assign_name: "Top001",
  title: "硬體無法運作",
  depiction: "點擊螢幕無反應，疑似觸控螢幕故障。",
  files: [
    { id: 1, name: "硬體管理系統問題截圖.doc", size: 10485760, type: "application/msword" },
    { id: 2, name: "螢幕故障示意圖.mp4", size: 20971520, type: "video/mp4" },
    { id: 3, name: "硬體系統圖片001.png", size: 5242880, type: "image/png" },
    { id: 4, name: "教育訓練文宣001.ppt", size: 10485760, type: "application/vnd.ms-powerpoint" },
    { id: 5, name: "系統測試報告001.pdf", size: 20971520, type: "application/pdf" }
  ]
}
