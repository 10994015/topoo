            ...
            <div class="handler-content">
              ...
              <div class="priority-grid">
                ...
                <div class="priority-item">
                  ...
                  <div class="priority-info">
                    ...
                    <span :class="[repairDetail.emergency_level ? 'priority-badge' : '', levelsMap[repairDetail.emergency_level] || '']">
                      {{ levels[repairDetail.emergency_level] || '-' }}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="handler-actions">
                <button 
                  @click="handAssign" 
                  class="accept-btn" 
                  v-if="hasWriteRepairTodoPermission && repairDetail.repair_status !== '已完成' && repairDetail.repair_status !== '歸檔'"
                >
                  <span class="btn-icon">{{ repairDetail.repair_status === '尚未承辦' ? '✋' : '🔧' }}</span>
                  <span class="btn-text">{{ repairDetail.repair_status === '尚未承辦' ? '承辦案件' : '處理案件' }}</span>
                </button>
                
                <button 
                  @click="restartTodo" 
                  class="reassign-btn" 
                  v-if="repairDetail.repair_status==='已完成' || repairDetail.repair_status==='歸檔'"
                >
                  <span class="btn-icon">🔄</span>
                  <span class="btn-text">重啟案件</span>
                </button>
              </div>
            </div>
          </div>
